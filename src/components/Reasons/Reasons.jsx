  ...
  return (
   <div className="Reasons" id="reasons">
    ...
    <div className="right-r">
        ...
        <div>
        <span className='stroke-text gg'> why </span>
            <span>  choose us? </span></div>
            <div className='details-r gg'>
            ...
            <div><img src={tick} alt="" /><span>RETABLE PARTINERS</span></div>
            <span  style={{  margin:'12px',color:'var(--gray)', fontWeigth:'normal'}}>OUR PARTNERS
            </span>
